...
namespace Database.Migrations
{
    ...
    [Migration("20240821204718_AddPatientTransactionDetails")]
    partial class AddPatientTransactionDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.PatientManagement.Billing.PatientTransaction", b =>
                {
                    ...
                    b.Property<Guid?>("TakenById1")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("TakenByIdId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TakenById1");

                    b.HasIndex("TakenByIdId");

                    b.ToTable("PatientTransactions", "PatientManagement");
                });

            modelBuilder.Entity("Domain.Entities.PatientManagement.Billing.PatientTransactionDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PatientTransactionDetails", "PatientManagement");
                });
            ...
            modelBuilder.Entity("Domain.Entities.PatientManagement.Extra.SmsHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PatientSmsHistories", "PatientManagement");
                });
            ...
            modelBuilder.Entity("Domain.Entities.PatientManagement.Family.FamilyMember", b =>
                {
                    ...
                    b.ToTable("FamilyMembers", "PatientManagement");
                });
            ...
            modelBuilder.Entity("Domain.Entities.PatientManagement.Billing.PatientTransaction", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.UserAccounts.User", "TakenBy")
                        .WithMany()
                        .HasForeignKey("TakenById1");

                    b.HasOne("Domain.Entities.UserAccounts.User", "TakenById")
                        .WithMany()
                        .HasForeignKey("TakenByIdId");

                    b.Navigation("Patient");

                    b.Navigation("TakenBy");

                    b.Navigation("TakenById");
                });

            modelBuilder.Entity("Domain.Entities.PatientManagement.Billing.PatientTransactionDetail", b =>
                {
                    b.HasOne("Domain.Entities.PatientManagement.Billing.PatientTransaction", "PatientTransaction")
                        .WithMany()
                        .HasForeignKey("PatientTransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PatientTransaction");
                });
