...
namespace Database.Migrations
{
    ...
    [Migration("20241022103728_UpdateDatabase336p")]
    partial class UpdateDatabase336p
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Settings.Immunisation.BatchDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BatchDetails", "Setting");
                });

            modelBuilder.Entity("Domain.Entities.Settings.Immunisation.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Settings.Immunisation.CourseSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Settings.Immunisation.ImmunisationSetup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Settings.Immunisation.Shot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Settings.Immunisation.ShotBatchDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Settings.Immunisation.ShotCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Settings.Immunisation.CourseSchedule", b =>
                {
                    b.HasOne("Domain.Entities.Settings.Immunisation.Course", "Course")
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Settings.Immunisation.ImmunisationSetup", "ImmunisationSetup")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Settings.Immunisation.ShotBatchDetail", b =>
                {
                    b.HasOne("Domain.Entities.Settings.Immunisation.BatchDetail", "BatchDetail")
                        .WithMany()
                        .HasForeignKey("BatchDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Settings.Immunisation.Shot", "Shot")
                        .WithMany()
